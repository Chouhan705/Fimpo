...
const styles = StyleSheet.create({
  ...
  rankNumber: { fontSize: 32, color: '#666', marginRight: 12, minWidth: 24, textAlign: 'center' },
  goldRankText: { color: '#F1C40F', fontWeight: 'bold' },
  avatarImg: { width: 60, height: 60, backgroundColor: '#262626', borderRadius: 22.5, marginRight: 15 },
  playerNameText: { fontSize: 20, color: '#FFF', textTransform: 'uppercase', letterSpacing: 1 },
  ...
  exitText: { color: '#777', fontSize: 16, letterSpacing: 1 },
  ...
  startRoundText: { fontSize: 18, letterSpacing: 1 }
});